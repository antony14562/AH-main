%Use this for multiple runs with different dim or T

N = 10^5;
sims = 2;
%d_vals = 4*round(logspace(0,3,sims));
d_vals = [100 200];
tol = 10^-8;
delta = 0.02; 
T = linspace(10,10,sims);
